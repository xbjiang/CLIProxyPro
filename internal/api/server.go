...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/routing/pinned-account", s.mgmt.GetPinnedAccount)
		...
		mgmt.GET("/relay-tag-pool", s.mgmt.GetRelayTagPool)
		mgmt.PUT("/relay-tag-pool", s.mgmt.PutRelayTagPool)
		...
		mgmt.POST("/auth-files/reset-status", s.mgmt.ResetAuthStatus)
